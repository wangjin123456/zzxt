...
public class SignatureManager {
	...
	protected SignatureManager(int platformCode) {
	...
	private static OnlineSigner signer = null;
	
	public static SignatureManager Instance(Integer platformCode){
		
		if(signatureManager == null) {
			
			signatureManager = new SignatureManager(platformCode);
		}
		
		if(platformCode == Global.SHANG_SHANG_SIGN) {
			signer = new ShangShangSigner();
		}
	 ...
	 * @param userType 签署者用户类型：APP.bestSignCode表示个人类型 ，2表示企业类型
	 * @return
	 */
	public boolean userReg(String account, String mail, String mobile, String name, int userType){
		
		return signer.userReg(account, mail, mobile, name, userType);
	...
	public boolean setUserSignatureImage(String account, int userType, byte[] signatureImageData){
		...
		return signer.setUserSignatureImage(account, userType, signatureImageData);
	}
	/**
	 * 查询签名/印章图片
	 * @param account 账号，即用户唯一标识
	...
	public byte[] getUserSignatureImageData(String account, int userType){
		...
		return signer.getUserSignatureImageData(account, userType);
	}
	/**
	 * 设置个人证件信息
	 * @param account 账号，即用户唯一标识
	 * @param identity  证件号码，对应证件类型  注：当前仅针对大陆APP.bestSignCode8位身份证号会进行身份证号格式校验
	...
	public boolean userSetPersonalCredential(String account, String identity, String identityType, String name, String contactMail, String contactMobile, String province, String city, String address){
		...
		return signer.userSetPersonalCredential(account, identity, identityType, name, contactMail, contactMobile, province, city, address);
	}
	...
	public boolean userSetEnterpriseCredential(String account, String regCode, String taxCode, String orgCode, String name, String legalPerson, String legalPersonIdentity, String legalPersonIdentityType, String legalPersonMobile, String contact, String contactMail, String contactMobile, String province, String city, String address){
		...
		return signer.userSetEnterpriseCredential(account, regCode, taxCode, orgCode, name, legalPerson, legalPersonIdentity, legalPersonIdentityType, legalPersonMobile, contact, contactMail, contactMobile, province, city, address);
	...
	public JSONObject userAsyncApplyCertSubmit(String account, String certType){
		...
		return signer.userAsyncApplyCertSubmit(account, certType);
	 ...
	 * @param account
	 * @param taskId
	 * @return status	APP.bestSignCode：新申请  2：申请中  3：超时 4：申请失败 5：成功-APP.bestSignCode：无效的申请（数据库无此值）
	...
	public JSONObject userAsyncApplyCertStatus(String account, String taskId){
		return signer.userAsyncApplyCertStatus(account, taskId);
	...
	public String userGetCert(String account, String certType){
		...
		return signer.userGetCert(account, certType);
	}
	/**
	 * 创建合同文件节点
	...
	public String contractCreateFileNode(String account,byte[] pdfData){
		...
		return signer.contractCreateFileNode(account, pdfData);
	...
	public JSONObject contractCreate(String senderAccount, String fid, String expireAt, String title, String description){
		...
		return signer.contractCreate(senderAccount, fid, expireAt, title, description);
	 ...
	 * @throws Exception 
	 */
	public void contractAddSigner(String contractId, String signerId) throws Exception{

		signer.contractAddSigner(contractId, signerId); 
	...
	public void contractAddSigners(String contractId, List<String> signers){
		...
		signer.contractAddSigners(contractId, signers);
	...
	public void contractSign(String contractId, String signerAccount, byte[] signatureImageData, String signerCert, int signPageNum, float signX, float signY, float signWidth, float signHeight) throws Exception{
		...
		signer.contractSign(contractId, signerAccount, signatureImageData, signerCert, signPageNum, signX, signY, signWidth, signHeight);
	}
	...
	public void contractSign(String contractId, String signerAccount, byte[] signatureImageData, String signerCert, JSONArray signaturePositions, float signWidth, float signHeight){
		...
		signer.contractSign(contractId, signerAccount, signatureImageData, signerCert, signaturePositions, signWidth, signHeight);
	...
	public void contractLock(String contractId) throws Exception{
		...
		signer.contractLock(contractId);
	...
	public void contractFinish(String contractId) throws Exception{
		...
		signer.contractFinish(contractId);
	...
	public byte[] contractDownload(String contractId){
		...
		return signer.contractDownload(contractId);
	...
	public JSONObject contractGetInfo(String contractId){
		...
		return signer.contractGetInfo(contractId);

	}
	
	public JSONObject userBaseInfo(String account){

		return signer.userBaseInfo(account);
