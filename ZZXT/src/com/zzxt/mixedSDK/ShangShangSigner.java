 ...
 */
@Component
public class ShangShangSigner implements OnlineSigner {
	...
	public String contractCreateFileNode(String account,byte[] pdfData){
		try {
			 String create = initData.getMixedSdk().contractCreateFileNode(account, pdfData);
			...
			return "-1:" + e.getLocalizedMessage();
		} 
